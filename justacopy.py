...
def getHighLow(symb, status, x, position): #3
    ...
    getLastTrades(symb, x, status, highPrice, lowPrice, rangeSize, position)

def getLastTrades(symb, x, status, highPrice, lowPrice, rangeSize, position):
    ...
    #prints
    #print(res_replace)
    print("AskP: " + str(askPrice)) #Ask Price #set as stop
